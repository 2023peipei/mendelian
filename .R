...
a<-fread("GCST90000514_buildGRCh37.txt",header = T)
b<-subset(a,p_value<5e-08)
write.csv(b, file="exposure.csv")
bmi_exp_dat<-read_exposure_data(filename = "exposure.csv",sep = ",",snp_col = "variant_id",beta_col = "beta",se_col = "standard_error",effect_allele_col = "effect_allele",other_allele_col = "other_allele",clump = TRUE)
